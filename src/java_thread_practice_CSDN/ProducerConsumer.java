...
public class ProducerConsumer {
    ...
    private static class MessageQueue {
        ...
        public synchronized void put(String message) {
            ...
            opIndex++;
            System.out.println("生产者 " + Thread.currentThread().getName() + " 生产了一条消息: " + message+" "+opIndex);
            // 生产后，对消费者进行唤醒
            notifyAll();
        }
        ...
        public synchronized String get() {
            ...
            opIndex--;
            System.out.println("消费者 " + Thread.currentThread().getName() + " 消费了一条消息: " + message+" "+opIndex);
            // 消费后，对生产者进行唤醒
            notifyAll();
            return message;
        }
